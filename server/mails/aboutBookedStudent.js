...
module.exports = function getConfirmEmail(name, avatar, lesson, tutor, user) {
    return `
    ${header()}
    <div style="
        width: 600px;
    ...
    ">
        ...
        <div style="
            ...
            text-align: center;
            color: #000;
        ">Thank you very much for<br/>booking a lesson with</div>
        ...
        <div style="
            ...
            color: #6C6C6C;
            margin-top: 20px;
        ">You will also get an email an hour<br/>before your lesson as a reminder</div>
