...
class Pick extends React.Component {
    ...
    render() {
        return <div className="page-block">
            {this.props.user._id === this.props.game.winner && <h1 className='game-title'>You win!</h1>}
            {this.props.user._id !== this.props.game.winner && <h1 className='game-title'>You lose.</h1>}
        </div>
    }
}
